...
/** Box / package icon — used as the workspace indicator in the input
 *  settings popup (replaces the previous 🏠 emoji). Matches the Lucide
 *  line-icon vocabulary used by Gear / Trash / Wrench / Paperclip. */
